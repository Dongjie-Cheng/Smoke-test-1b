#!/bin/bash
#SBATCH --job-name=eval-sow-stage3
#SBATCH --gres=gpu:1
...
python -m project.tools.build_sow_aligned_manifests --stage stage3

TTS_AUDIO_ROOT=${TTS_AUDIO_ROOT:-}
ESC50_ROOT=${ESC50_ROOT:-}
CMD=(python -m project.tools.build_sow_translation_audio_manifests --stage-dir data_manifests/sow_stage3 --snr-db 20)
...
python -m project.run_eval_sow_aligned --spec eval_spec_sow_stage3.yaml
